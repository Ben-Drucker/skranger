...
class RangerTreeRegressor(BaseRangerTree, RegressorMixin, BaseEstimator):
    r"""Ranger Tree Regression implementation for sci-kit learn.
    ...
    def from_forest(cls, forest: "RangerForestRegressor", idx: int):
        ...
        instance = cls(
            ...
            split_select_weights=forest.split_select_weights,
            always_split_features=forest.always_split_features,
            categorical_features=forest.categorical_features,
